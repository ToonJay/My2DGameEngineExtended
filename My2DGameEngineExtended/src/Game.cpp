...
void Game::Setup() {
	...
	registry->emplace<Transform>(entity, glm::vec2(200, virtualHeight/2 - 200), glm::vec2(2, 2));
	...
	registry->emplace<BoxCollider>(entity, 8, 11, glm::vec2(4, 3));
	...
	registry->emplace<Transform>(tile, glm::vec2(500, virtualHeight / 2), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile2, glm::vec2(500, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile3, glm::vec2(468, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile4, glm::vec2(436, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile5, glm::vec2(404, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile6, glm::vec2(372, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile7, glm::vec2(340, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile8, glm::vec2(308, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile9, glm::vec2(276, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile10, glm::vec2(244, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile11, glm::vec2(212, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile12, glm::vec2(180, virtualHeight / 2 + 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile13, glm::vec2(468, virtualHeight / 2 - 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile14, glm::vec2(500, virtualHeight / 2 - 32), glm::vec2(2, 2));
	...
	registry->emplace<Transform>(tile15, glm::vec2(532, virtualHeight / 2 + 32), glm::vec2(2, 2));
	registry->emplace<Sprite>(tile15, "tile", 16, 16, SDL_FLIP_NONE, 0, true, 64, 0);
	registry->emplace<BoxCollider>(tile15, 16, 16, glm::vec2(0, 0));
	registry->emplace<Tag>(tile15, "tile");
}
